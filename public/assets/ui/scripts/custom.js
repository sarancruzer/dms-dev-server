...
$(document).ready(function(){
	...
	if ($("table#pricing-list-container").is('*')) {
		...
		// 	newMenuItem();
		// });
		$(".add-pricing-list-item").unbind().click(function(e) {
			e.preventDefault();
			newMenuItem();
		});	
		...
		$(".add-pricing-submenu").unbind().click(function(e) {
			e.preventDefault();
			var newElem = $(''+
				'<tr class="pricing-list-item pricing-submenu" ng-repeat="cat in categories">'+
				'<td>'+
				'<div class="fm-move"><i class="sl sl-icon-cursor-move"></i></div>'+
				'<div class="fm-input"><input type="text" placeholder="Category Title" name="categoryTitle[]" id="categoryTitle-'+j+'" /></div>'+
				'<div class="fm-close"><a class="removetr" href="javascript:;"><i class="fa fa-remove"></i></a></div>'+
				'</td>'+
				'</tr>');
			j++;
			$('table#pricing-list-container tr:last').after(newElem);
			//newElem.appendTo('table#pricing-list-container');
		});


		$('table#pricing-list-container ').sortable({
