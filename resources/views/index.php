...
<script type="text/javascript" src="assets/ui/scripts/infobox.min.js"></script>
<script type="text/javascript" src="assets/ui/scripts/markerclusterer.js"></script>
<script type="text/javascript" src="assets/ui/scripts/maps.js"></script>
...
<script type="text/javascript" src="assets/js/jquery-validate/additional-methods.min.js"></script>
    ...
    <script type="text/javascript" src="assets/lib/ng-fileUpload/ng-file-upload-shim.min.js"></script><!-- for no html5 browsers support -->
	<script type="text/javascript" src="assets/lib/ng-fileUpload/ng-file-upload.min.js"></script>
    ...
    <script src="app/modules/listing/controllers/editlistingController.js"></script>
    <script src="app/modules/listing/controllers/mylistingController.js"></script>
    <script src="app/modules/listing/controllers/searchlistingController.js"></script>

    <script src="app/modules/blogs/controllers/addblogController.js"></script>
    <script src="app/modules/blogs/controllers/editblogController.js"></script>
    <script src="app/modules/blogs/controllers/manageblogsController.js"></script>
    <script src="app/modules/blogs/controllers/detailblogController.js"></script>
    ...
    <script src="app/modules/reviews/controllers/reviewsController.js"></script>
